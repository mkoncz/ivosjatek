    ...
    return (
        <div className="page-frame">
            <Helmet>
                ...
                <meta name="twitter:title" content="Biztosítást kötött a péniszére ez a férfi"/>
                <meta name="twitter:description" content="1 millió dolláros (350 millió forintos) biztosítást kötött a péniszére ez a férfi" />
            ...
            <p className="post-source-p">
                A Brazzers kiadó 1 millió dolláros (350 millió forintos) biztosítást kötött Keiran péniszére.
                A szerződést a Lloyd's of London biztosítótársasággal kötötték, akiknél nem ez volt az első alkalom, hogy egy híresség
            ...
            <div align="center">
                <div className="post-card">
                    <div className="post-card-text">
                        Mindenki mond egy pornóoldalt. A jobbra ülő kezd, és addig mennek a körök, amíg valaki már nem tud mondani. Ő iszik.
                    </div>
                </div>
                <div className="post-card">
                    <div className="post-card-text">
                        Az iszik, aki mérte már meg egy pénisz hosszát.
                    </div>
                </div>
                <div className="post-card">
                    <div className="post-card-text">
                        Igyon egyet, aki szexelt már olyannal, akinek nem tudta a nevét!
                  </div>
                </div>
                <div>
